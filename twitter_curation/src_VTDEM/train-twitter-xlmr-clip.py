...
from twitterXlm import VisionTextDualEncoderModel
import evaluate
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        data_files = get_dataset_files(data_args.dataset_name, return_with_translations)
        ds_translation = []
    ...
    config = model.vision_encoder.config #vision_text_model
    ...
    if training_args.do_predict:
        ...
        write_preds_to_file(
            texts, predictions, original_labels, training_args.output_dir
        )
